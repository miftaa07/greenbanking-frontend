...
const footerLinks = {
  ...
  Institusi: ['Teknologi Informasi', 'Fakultas Vokasi', 'Universitas Brawijaya'],
}
            ...
            <div>
              ...
              <div className="space-y-4">
                {[
                  ...
                  { icon: 'M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253', label: 'Program Studi', val: 'Teknologi Informasi' },
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-10 mb-10">
            ...
            <div className="col-span-2 lg:col-span-1">
              ...
              <div className="flex gap-3">
                <a href="mailto:research@greenbanking.ac.id" className="w-7 h-7 bg-gray-800 hover:bg-green-600 rounded-lg flex items-center justify-center transition-colors">
                  <Mail className="w-3.5 h-3.5 text-gray-400" strokeWidth={2.5} />
                </a>
              </div>
            </div>
